...
#define GetAppVersion GetFileVersion("C:\tt5dist\TeamTalk5_x64\TeamTalk5\Build\install\x64\Client\qtTeamTalk\TeamTalk5.exe")
...
AllowNoIcons=yes
OutputBaseFilename=TeamTalk_v5.18.0.5159_Setup
