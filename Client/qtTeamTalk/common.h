...
{
    TTS_NONE                                        = 0x0,
    TTS_USER_LOGGEDIN                               = 1 << 0,
    TTS_USER_LOGGEDOUT                              = 1 << 1,
    TTS_USER_JOINED                                 = 1 << 2,
    TTS_USER_LEFT                                   = 1 << 3,
    TTS_USER_JOINED_SAME                            = 1 << 4,
    TTS_USER_LEFT_SAME                              = 1 << 5,
    TTS_USER_TEXTMSG_PRIVATE                        = 1 << 6,
    TTS_USER_TEXTMSG_PRIVATE_SEND                   = 1 << 7,
    TTS_USER_TEXTMSG_PRIVATE_TYPING                 = qulonglong(1) << 35,
    TTS_USER_TEXTMSG_PRIVATE_TYPING_GLOBAL          = qulonglong(1) << 36,

    TTS_USER_TEXTMSG_CHANNEL                        = 1 << 8,
    TTS_USER_TEXTMSG_CHANNEL_SEND                   = 1 << 9,
    TTS_USER_TEXTMSG_BROADCAST                      = 1 << 10,
    TTS_USER_TEXTMSG_BROADCAST_SEND                 = 1 << 11,

    TTS_SUBSCRIPTIONS_TEXTMSG_PRIVATE               = 1 << 12,
    TTS_SUBSCRIPTIONS_TEXTMSG_CHANNEL               = 1 << 13,
    TTS_SUBSCRIPTIONS_TEXTMSG_BROADCAST             = 1 << 14,
    TTS_SUBSCRIPTIONS_VOICE                         = 1 << 15,
    TTS_SUBSCRIPTIONS_VIDEO                         = 1 << 16,
    TTS_SUBSCRIPTIONS_DESKTOP                       = 1 << 17,
    TTS_SUBSCRIPTIONS_DESKTOPINPUT                  = 1 << 18,
    TTS_SUBSCRIPTIONS_MEDIAFILE                     = 1 << 19,

    TTS_SUBSCRIPTIONS_INTERCEPT_TEXTMSG_PRIVATE     = 1 << 20,
    TTS_SUBSCRIPTIONS_INTERCEPT_TEXTMSG_CHANNEL     = 1 << 21,
    TTS_SUBSCRIPTIONS_INTERCEPT_VOICE               = 1 << 22,
    TTS_SUBSCRIPTIONS_INTERCEPT_VIDEO               = 1 << 23,
    TTS_SUBSCRIPTIONS_INTERCEPT_DESKTOP             = 1 << 24,
    TTS_SUBSCRIPTIONS_INTERCEPT_MEDIAFILE           = 1 << 25,

    TTS_CLASSROOM_CHANMSG_TX                        = 1 << 26,
    TTS_CLASSROOM_VOICE_TX                          = 1 << 27,
    TTS_CLASSROOM_VIDEO_TX                          = 1 << 28,
    TTS_CLASSROOM_DESKTOP_TX                        = 1 << 29,
    TTS_CLASSROOM_MEDIAFILE_TX                      = 1 << 30,
