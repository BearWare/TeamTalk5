...
{
    (ui.msgEdit->text().size()>0 ? ui.msgEdit->setAccessibleName(QString(tr("New message (%1 of 512 characters)").arg(ui.msgEdit->text().size()))) : tr("New message"));
    ui.sendButton->setVisible(ui.msgEdit->text().size()>0);
    (ui.videomsgEdit->text().size()>0 ? ui.videomsgEdit->setAccessibleName(QString(tr("New message (%1 of 512 characters)").arg(ui.videomsgEdit->text().size()))) : tr("New message"));
    ui.videosendButton->setVisible(ui.videomsgEdit->text().size()>0);
    (ui.desktopmsgEdit->text().size()>0 ? ui.desktopmsgEdit->setAccessibleName(QString(tr("New message (%1 of 512 characters)").arg(ui.desktopmsgEdit->text().size()))) : tr("New message"));
