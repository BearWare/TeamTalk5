...
TTLIBS_ROOT = $$(HOME)/tt5dist/toolchain/ubuntu22
android: TTLIBS_ROOT = $$(HOME)/tt5dist/toolchain/android/armeabi-v7a #TODO: add all architectures
...
INCLUDEPATH += $$TTLIBS_ROOT/speexdsp/include
INCLUDEPATH += $$TTLIBS_ROOT/tinyxml/include
...
# Special case for opus-tools
INCLUDEPATH += $$TTLIBS_ROOT/opustools/src
...
LIBS += $$TTLIBS_ROOT/speexdsp/lib/libspeexdsp.a
# ffmpeg, use static
...
#tinyxml
LIBS += $$TTLIBS_ROOT/tinyxml/lib/libtinyxml.a
...
#QMAKE_CXXFLAGS += -Wall
QMAKE_CXXFLAGS += -D__ACE_INLINE__  # ace
QMAKE_CXXFLAGS += -D__STDC_CONSTANT_MACROS # ffmpeg
QMAKE_CXXFLAGS += -DENABLE_ENCRYPTION -DENABLE_OPUS -DENABLE_OGG \
                  -DENABLE_OPUSTOOLS -DENABLE_SPEEX \
                  -DENABLE_FFMPEG3 -DENABLE_VPX -DENABLE_WEBRTC -DENABLE_TEAMTALKPRO
...
SOURCES +=  $$TEAMTALKLIB_ROOT/test/CatchMain.cpp \
            ...
            $$TTLIBS_ROOT/opustools/src/opus_header.c \
            main.cpp
