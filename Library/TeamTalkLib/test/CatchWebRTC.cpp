...
TEST_CASE("webrtc-audiobuf") {
    ...
    std::vector<short> out_buff(OUT_SAMPLES * IN_CH);
    ...
    REQUIRE(outwavfile.NewFile(ACE_TEXT("out_tone.wav"), OUT_SR, IN_CH));
    ...
    webrtc::StreamConfig out_cfg(OUT_SR, IN_CH);
