...
if (FEATURE_VORBIS)
  include (vorbis)
  list (APPEND CODEC_COMPILE_FLAGS -DENABLE_VORBIS)
  list (APPEND CODEC_COMPILE_FLAGS -DENABLE_VORBISTOOLS)
  list (APPEND CODEC_LINK_FLAGS ${VORBIS_LINK_FLAGS})
  list (APPEND CODEC_SOURCES ${TEAMTALKLIB_ROOT}/codec/VorbisEncoder.cpp)
  list (APPEND CODEC_SOURCES ${TEAMTALKLIB_ROOT}/codec/VorbisDecoder.cpp)
  list (APPEND CODEC_HEADERS ${TEAMTALKLIB_ROOT}/codec/VorbisEncoder.h)
  list (APPEND CODEC_HEADERS ${TEAMTALKLIB_ROOT}/codec/VorbisDecoder.h)
endif()
