...
if (FFMPEG)
  ...
  if (${CMAKE_SYSTEM_NAME} MATCHES "Linux")
    ...
    if (V4L2)
      ...
      list (APPEND AVSTREAM_COMPILE_FLAGS -DENABLE_VIDCAP -DENABLE_V4L2)
    endif()
  endif()
  ...
  if (${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
    ...
    if (AVF)
      ...
      list (APPEND AVSTREAM_HEADERS ${TEAMTALKLIB_ROOT}/avstream/FFMpeg3Capture.h)
      list (APPEND AVSTREAM_HEADERS ${TEAMTALKLIB_ROOT}/avstream/VideoCapture.h)
      list (APPEND AVSTREAM_COMPILE_FLAGS -DENABLE_VIDCAP -DENABLE_AVF)
    endif()
  endif()
endif()
...
if (MSVC)
  ...
  if (VIDCAP)
    ...
    list (APPEND AVSTREAM_COMPILE_FLAGS -DENABLE_VIDCAP -DENABLE_LIBVIDCAP )
  endif()
  
  option (MEDIAFOUNDATION "Build Media Foundation Streaming classes" ON)

  if (MEDIAFOUNDATION)
    list (APPEND AVSTREAM_COMPILE_FLAGS -DWINVER=0x0601) #_WIN32_WINNT_WIN7
