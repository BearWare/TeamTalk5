...
extern "C" {
     ...
     *
     * Register using TTS_Register UserDeleteServerBanCallback().
     *
     * @param lpTTSInstance The server instance where the event is occurring.
     * @param lpUserData The user data supplied to register-callback function.
    ...
    /**
     * @brief Register a callback to perform user login on the server.
     *
     * @param lpTTSInstance Pointer to the server instance created by
     * TTS_InitTeamTalk().
    ...
    /**
     * @brief Register a callback to create a new user account on the
     * server.
     *
     * @param lpTTSInstance Pointer to the server instance created by
     * TTS_InitTeamTalk().
    ...
    /**
     * @brief Register a callback to delete a user account on the
     * server.
     *
     * @param lpTTSInstance Pointer to the server instance created by
     * TTS_InitTeamTalk().
    ...
    /**
     * @brief Register a callback to add a server ban requested by a
     * user.
     *
     * @param lpTTSInstance Pointer to the server instance created by
     * TTS_InitTeamTalk().
    ...
    /**
     * @brief Register a callback to add a server IP-address ban
     * requested by a user.
     *
     * @param lpTTSInstance Pointer to the server instance created by
     * TTS_InitTeamTalk().
    ...
    /**
     * @brief Register a callback to delete a server IP-address ban
     * requested by a user.
     *
     * @param lpTTSInstance Pointer to the server instance created by
     * TTS_InitTeamTalk().
